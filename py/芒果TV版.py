...
class Spider(Spider):
    ...
    def playerContent(self, flag, id, vipFlags):
        ...
        # 修复：更换为稳定解析接口，同时保留原解析作为备选
        # 主解析：爱豆解析 (https://jx.aidouer.net/)
        # 备选：1080pku (https://api.1080pku.com/)
        parser_url = 'https://jx.aidouer.net/?url='
        # 若爱豆解析失效，可手动改为以下任意一个：
        # parser_url = 'https://api.1080pku.com/?url='
        # parser_url = 'https://jx.parwix.com:4433/?url='
